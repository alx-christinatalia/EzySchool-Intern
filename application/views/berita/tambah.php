...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Tambah Berita | <?php echo $this->config->item("app_title"); ?></title>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="page-title">
                                    <h1><i class="fa fa-newspaper-o"></i> Tambah Berita</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a href="#" onclick="location.reload();">Tambah Berita</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <form method="POST" action="berita/ajax-berita.html" class="form-horizontal form-berita-baru">
                        ...
                        <div class="hidden tambahberita row" style="margin-top: 0px;">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                            ...
                                            <div style="margin-left: 0px; margin-right: 0px; padding-left:15px; padding-right: 15px;" class="row">
                                                <div>
                                                    <div class='input-group date' style="margin-bottom: 10px">
                                                        <input id='datetimepicker6' disabled type='text' class="form-control tanggal tgl_eksekusi_edit date-set" placeholder="Tanggal Post" value="<?php echo $date; ?>"/>
                                ...
                                <div class="portlet light bordered section2 mrg-btm15">
                                    ...
                                    <div class="portlet-body">
                                        <div class="solid white">
                                            <div class="text-center gambar" style="margin-left: 0px; margin-right: 0px; padding-left:15px; padding-right: 15px;">
                                                <img src="" class="img-responsive img-thumbnail hidden img-preview" style="width: 200px;">
                    ...
                    if(base64 != "") {
                        ...
                        uploadfoto(ajaxtarget, base64, function(resp) {
                            InsertData(form, function(resp) {
                                setTimeout(function() {
                                    window.location.href = "<?php echo base_url("berita/edit.html?id=")?>" + resp.Output;
                                }, 750);
                            });
                        }, "uploadfoto");
                    } else {
