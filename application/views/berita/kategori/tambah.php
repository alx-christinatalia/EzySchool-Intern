...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Tambah Kategori Berita | EzySchool Sekolah</title>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="page-title">
                                    <h1><i class="fa fa-tasks"></i> Tambah Kategori Berita</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    <li>
                                        <span class="active text-default">Kategori Berita</span>
                                        <i class="fa fa-circle"></i>
                                    </li>
                                    <li>
                                        <span class="active text-default">
                                            <a href="#" onclick="location.reload();">Tambah Kategori Berita</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="portlet custom light bordered">
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <form class="form-horizontal" action="berita/ajax-berita-kategori.html" role="form" id="FrmAddKategori">
                    ...
                    $.each(valueJSON.items, function(index, item) {
                        if(!empty(item.nama)) {
                            ...
                            InsertRepeaterData2(datSis, actionForm, function(){
                                setTimeout(function() {
                                    window.location.href = "<?php echo base_url("berita/kategori.html")?>";
                                }, 750);
                            });
