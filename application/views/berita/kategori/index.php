...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Kategori Berita | EzySchool Sekolah</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="page-title">
                                    <h1><i class="fa fa-newspaper-o"></i> Kategori Berita</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a onclick="location.reload();">Kategori Berita</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm-7 text-right">
                                <div class=" form-inline">
                                    ...
                                    <div class="form-group " style="margin-bottom:15px;">
                                        ...
                                        <!-- <a data-toggle="modal" data-target="#modalAdd" role="button" class="btn btn-primary tambah-kategori-berita">
                                            <i class="fa fa-plus"></i>
                                        </a> -->
                                        <a role="button" class="btn btn-primary" href="<?php echo base_url("berita/kategori/tambah.html");?>" title="Tambah Kategori Pengumuman">
                                            <i class="fa fa-plus"></i>
                                        </a>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width:100%;" class="form-control select2-nosearch sort" class="form">
                                                        ...
                                                        <option value="id asc">ID Kategori [A-Z]</option>
                                                        <option value="id desc">ID Kategori [Z-A]</option>
        ...
        <?php $this->load->view("berita/kategori/modal/tambah"); ?>
        <?php $this->load->view("berita/kategori/modal/edit-data"); ?>
        <?php $this->load->view("berita/kategori/modal/edit-status"); ?>
        <?php $this->load->view("berita/kategori/modal/import") ?>
        ...
        <script>
            pagename = "berita/ajax-berita-kategori.html";
            ...
            $(".datatable tbody").on("click", ".edit-data", function() {
                resetformvalue(".form-edit-kategori");
                var FrmSave = $(".form-edit-kategori");
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-edit-kategori .modal-title").html("Edit Kategori Berita " + resp.nama);
            ...
            var FrmSaveWebsite = $(".form-edit-kategori").validate({
            ...
            $(".fileimportkategori").change(function() {
                var selector = $(this);
                if (this.files && this.files[0]) {
                    ...
                    if((this.files[0].size / 1024) < 2048){
                        ...
                        FR.addEventListener("load", function(e) {
                            ...
                            $(".fileimportkategori-hidden").val(base64);
                            $(".fileimportkategoriext-hidden").val(ext);
                        }); 
            ...
            var FrmSaveWebsite = $(".form-import-kategori").validate({
                submitHandler: function(form) {
