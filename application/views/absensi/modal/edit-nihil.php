<div class="modal fade modal-update-status" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="FrmUpdateStatus" action="" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Status <span class="text-danger">*</span></label>
                        <select class="select2-nosearch dropdown-status" name="form[nihil]" required style="width: 100%;">
                            <option value="1">Nihil</option>
                            <option value="0">Tidak Nihil</option>
                        </select>
                    </div>
                </div>
