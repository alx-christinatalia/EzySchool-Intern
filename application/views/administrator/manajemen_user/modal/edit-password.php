<div class="modal fade modal-save-password" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="FrmSavePassword" action="administrator/ajax-user.html" role="form">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Password Baru<span class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="pass1" required placeholder="Password Baru" minlength="6" maxlength="18" autofocus> 
                    </div>
                    <div class="form-group">
                        <label>Ketik Ulang Password Baru<span class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="pass2" required placeholder="Ketik Ulang Password Baru" minlength="6" maxlength="18">
                    </div>
                </div>
