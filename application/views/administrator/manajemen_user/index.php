...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Manajemen User | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h1 class="title-edit"><i class="fa fa-user"></i> Manajemen User</h1>
                                </div>
                                 <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a href="#" onclick="location.reload();">Manajemen User</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm-6 text-right">
                                <div class="form-inline">
                                    <div class="form-group" style="margin-bottom:15px;">
                                        <form id="FrmSearch">
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari (NIP, Nama, Username, Email)" class="form-control kywd" autofocus title="Cari (NIP, Nama, Username, Email)"> 
                                    ...
                                    <div class="form-group" style="margin-bottom:15px;">
                                        ...
                                        <a href="<?php echo base_url('manajemen_user/tambah.html') ?>" role="button" class="btn btn-primary" title="Tambah User">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width:100%;" class="form-control select2-nosearch sort" class="form">
                                                        <option value="nama asc">Default</option>
                                                        <option value="nama asc">Nama User [A-Z]</option>
                                                        <option value="nama desc">Nama User [Z-A]</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table table-striped table-hover datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="min-width: 125px;"> Jenis Kelamin </th>
        ...
        <?php $this->load->view("administrator/manajemen_user/modal/import") ?>
        <?php $this->load->view("administrator/manajemen_user/modal/edit-password") ?>
        <?php $this->load->view("administrator/manajemen_user/modal/edit-status") ?>
        <?php $this->load->view("administrator/manajemen_user/modal/detail") ?>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                document.getElementById("form-import-pegawai").reset();
            });
            ...
            $(".datatable tbody").on("click", ".detail-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-detail .modal-title").html("Detail User " + resp.nama);
