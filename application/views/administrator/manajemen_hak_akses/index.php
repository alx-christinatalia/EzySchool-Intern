...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Manajemen Hak Akses | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h1 class="title-edit"><i class="fa fa-user"></i> Manajemen Hak Akses</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a href="#" onclick="location.reload();">Manajemen Hak Akses</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm-6 text-right">
                                <div class="form-inline">
                                    ...
                                    <div class="form-group" style="margin-bottom:15px;">
                                        <a href="<?php echo base_url("manajemen_hak_akses/tambah.html"); ?>" role="button" class="btn btn-primary" title="Tambah Hak Akses">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width:100%;" class="form-control select2-nosearch sort" class="form">
                                                        ...
                                                        <option value="nama asc">Nama Hak Akses [A-Z]</option>
                                                        <option value="nama desc">Nama Hak Akses [Z-A]</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table table-striped table-hover  datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th> Nama </th>
                                                    <th style="width: 375px;"> Catatan </th>
                                                    <th style="width: 138px;"> Last Update </th>
        ...
        <?php $this->load->view("administrator/manajemen_hak_akses/modal/edit-status") ?>
        ...
        <script>
            ...
            $(".datatable tbody").on("click", ".status-data", function() {
                ...
                $(".hidden-idupdatestatus").val(id_update);
