...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Edit Hak Akses | <?php echo $this->config->item("app_title"); ?></title>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="page-title">
                                    <h1 class="title-edit"><i class="fa fa-user"></i> Edit Hak Akses</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a href="#" class="button-reload" onclick="location.reload();">Edit Hak Akses</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="portlet custom light bordered">
                                <div class="portlet-body">
                                    <form class="form-horizontal form-edit-roles" action="administrator/ajax-hak-akses.html">
        ...
        <script>
            ...
            $(document).ready(function() {
                if(!empty(id_update)) {
                    ...
                    $(".hasil-error .ket").html("<center><span class='label label-warning'>ID Hak Akses tidak valid</span></center>");
            ...
            function documentready() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    if(empty(resp.Data)) {
                        $(".hasil-error .ket").html("<center><span class='label label-warning'>Tidak ada data hak akses</span></center>");
                        $(".simpandata").addClass("hidden");
                        return;
                    }
                    ...
                    var allVals = resp.hak_akses.split(",");
                    $.each(allVals, function(index, item) {
                        if(/\./g.test(item)) {
                            $(".checkhak_aksessubmenu[value='"+item+"']").click();
                        } else {
                            $(".checkhak_aksesmenu[value='"+item+"']").click();
                        }
                    });
                });
            }

            var FrmSaveWebsite = $(".form-edit-roles").validate({
