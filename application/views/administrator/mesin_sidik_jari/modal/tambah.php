<div class="modal fade modal-tambah-mesin" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="FrmAddMesin" action="administrator/ajax-mesin-sidik-jari.html" role="form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Server</label>
                        <select class="select2-normal dropdown-server server" name="form[id_mesin_server]" style="width: 100%;">
                            <option value="">Pilih Server</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Unique ID<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="form[uid_mesin_finger]" placeholder="Unique ID" required>
                    </div>
                    <div class="form-group">
                        <label>Catatan</label>
