...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Mesin Sidik Jari | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="page-title">
                                    <h1><i class="fa fa-user"></i> Mesin Sidik Jari</h1>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group text-center">
                                        <form id="FrmSearch">
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari (Unique ID, Server)" class="form-control kywd" autofocus> 
                    ...
                    <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active text-default">
                                <a href="#" onclick="location.reload();">Mesin Sidik Jari</a>
                            </span>
                        </li>
                    </ul>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2-nosearch sort" class="form">
                                                            ...
                                                            <option value="id asc">ID Mesin Sidik Jari [A-Z]</option>
                                                            <option value="id desc">ID Mesin Sidik Jari [Z-A]</option>
                                                        </select>
                                                    </div>
                                                </div>
        ...
        <?php $this->load->view("administrator/mesin_sidik_jari/modal/tambah") ?>
        <?php $this->load->view("administrator/mesin_sidik_jari/modal/edit-data") ?>
        <?php $this->load->view("administrator/mesin_sidik_jari/modal/edit-status") ?>
        ...
        <script>
            pagename = "administrator/ajax-mesin-sidik-jari.html";
            $(document).ready(function() {
                ...
                $(".tambah-mesin").on("click", function() {
                    ...
                    $(".modal-tambah-mesin .modal-title").html("Tambah Mesin Sidik Jari");
            ...
            $(".datatable tbody").on("click", ".edit-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    FrmSave.find("select[name='form[id_mesin_server]']").val(resp.id_mesin_server).trigger("change");
                    FrmSave.find("input[name='form[uid_mesin_finger]']").val(resp.uid_mesin_finger);
                    if (!empty(resp.id_sekolah) && resp.uid_mesin_finger != "0") {
                        FrmSave.find("input[name='form[uid_mesin_finger]']").prop("readonly", true);
                    }
                    else if (!empty(resp.id_sekolah) && resp.uid_mesin_finger == "0") {
                        FrmSave.find("input[name='form[uid_mesin_finger]']").removeProp("readonly");
                    }
                    else if (empty(resp.id_sekolah)) {
                        FrmSave.find("input[name='form[uid_mesin_finger]']").removeProp("readonly");
                    }
                    FrmSave.find("textarea[name='form[catatan]']").val(resp.catatan);
                    $(".modal-save-mesin .modal-title").html("Edit Mesin ID: " + resp.uid_mesin_finger);
            ...
            $(".datatable tbody").on("click", ".status-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-update-status .modal-title").html("Edit Status " + resp.uid_mesin_finger);
