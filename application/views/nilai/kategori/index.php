...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Kategori Nilai | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="page-title">
                                    <h1><i class="fa fa-tasks"></i> Kategori Nilai</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a onclick="location.reload();">Kategori Nilai</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm-7 text-right">
                                <div class="form-inline">
                                    ...
                                    <div class="form-group" style="margin-bottom:15px;">
                                        ...
                                        <!-- <a data-toggle="modal" data-target="#modalAdd" role="button" class="btn btn-primary tambah-kategori-nilai">
                                            <i class="fa fa-plus"></i>
                                        </a> -->
                                        <a role="button" class="btn btn-primary" href="<?php echo base_url("nilai/kategori/tambah.html");?>" title="Tambah Kategori Nilai">
                                            <i class="fa fa-plus"></i>
                                        </a>
        ...
        <?php $this->load->view("nilai/kategori/modal/tambah"); ?>
        <?php $this->load->view("nilai/kategori/modal/edit-data"); ?>
        <?php $this->load->view("nilai/kategori/modal/edit-status"); ?>
        ...
        <script>
            ...
            $(".datatable tbody").on("click", ".edit-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-edit-kategori .modal-title").html("Edit Kategori Nilai " + resp.nama);
