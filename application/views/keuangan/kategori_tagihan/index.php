...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Kategori Tagihan | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class=" col-sm-5">
                                <div class="page-title">
                                    <h1><i class="fa fa-money"></i> Kategori Tagihan</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a href="#" onclick="location.reload();">Kategori Tagihan</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-sm-7 text-right">
                                <div class="form-inline">
                                    <div class="form-group " style="margin-bottom:15px;">
                                        <form id="FrmSearch">
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari (Prefix ID, Keterangan)" class="form-control kywd" autofocus title="Cari (Prefix ID, Keterangan)"> 
                                    ...
                                    <div class="form-group" style="margin-bottom:15px;">
                                        <a role="button" class="btn btn-primary tambah-kategori" title="Tambah Kategori">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width:100%;" class="form-control select2-nosearch sort" class="form">
                                                        ...
                                                        <option value="nama asc">Nama Kategori [A-Z]</option>
                                                        <option value="nama desc">Nama Kategori [Z-A]</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table table-striped table-hover datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 75px;"> Prefix ID </th>
                                                    <th> Keterangan </th>
        ...
        <?php $this->load->view("keuangan/kategori_tagihan/modal/tambah") ?>
        <?php $this->load->view("keuangan/kategori_tagihan/modal/edit-data") ?>
        <?php $this->load->view("keuangan/kategori_tagihan/modal/edit-status") ?>
        <?php $this->load->view("keuangan/kategori_tagihan/modal/detail") ?>
        ...
        <script>
            pagename = "keuangan/ajax-kategori-tagihan.html";
            $(document).ready(function() {
                GetData(request);

                $(".tambah-kategori").on("click", function() {
                    resetformvalue("#FrmAddKategori");
                    $(".modal-tambah-kategori .modal-title").html("Tambah Kategori Tagihan");
            ...
            $(".datatable tbody").on("click", ".status-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-update-status .modal-title").html("Edit Status Kategori Tagihan " + resp.nama);
            ...
            $(".datatable tbody").on("click", ".edit-data", function() {
                resetformvalue("#FrmSaveKategori");
                var FrmSave = $("#FrmSaveKategori");
                var id_update = $(this).data("idupdate");
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    FrmSave.find("input[name='form[prefix_id_tagihan]']").val(resp.prefix_id_tagihan);
                    FrmSave.find("input[name='form[nama]']").val(resp.nama);
                    FrmSave.find("textarea[name='form[default_keterangan]']").val(resp.default_keterangan);

                    $(".modal-save-kategori .modal-title").html("Edit Kategori Tagihan " + resp.nama);
                    $(".modal-save-kategori").modal("show");
                });
            });

            var FrmSaveKategori = $("#FrmSaveKategori").validate({
                submitHandler: function(form) {
                    UpdateData(form, function(resp) {
                        GetData(request);
                    });                    
            ...
            var FrmAddKategori = $("#FrmAddKategori").validate({
                submitHandler: function(form) {
