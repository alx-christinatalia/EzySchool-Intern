<div class="modal fade modal-tambah-kategori" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="FrmAddKategori" action="keuangan/ajax-kategori-tagihan.html" role="form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control abb" name="form[prefix_id_tagihan]" placeholder="Prefix ID" required minlength="1" maxlength="3">
                    </div>
                    <div class="form-group">
