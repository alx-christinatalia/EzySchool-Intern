...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Daftar Pengumuman | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="page-title">
                                    <h1><i class="fa fa-bullhorn"></i> Daftar Pengumuman</h1>
                                </div>
                                <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb col-xs-12">
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a onclick="location.reload();"> Daftar Pengumuman</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                <div class="form-inline">
                                    <div class="form-group " style="margin-bottom:15px;">
                                        <form id="FrmSearch">
                                            <div class="input-group input-search">
                                                <input type="text" placeholder="Cari (Judul Pengumuman)" class="form-control kywd" autofocus title="Cari (Judul Pengumuman)"> 
                                    ...
                                    <div class="form-group" style="margin-bottom:15px;">
                                        <a href="<?php echo base_url("pengumuman/tambah.html"); ?>" role="button" class="btn btn-primary" title="Tambah Pengumuman">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width:100%;" class="form-control select2-nosearch sort" class="form">
                                                        ...
                                                        <option value="tgl_eksekusi asc">Waktu Post [A-Z]</option>
                                                        <option value="tgl_eksekusi desc">Waktu Post [Z-A]</option>
        ...
        <?php $this->load->view("pengumuman/modal/edit-status") ?>
        <?php $this->load->view("pengumuman/modal/detail") ?>
        ...
        <script>
            ...
            $(".datatable tbody").on("click", ".detail-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-detail .modal-title").html("Detail Pengumuman " + resp.subyek);
            ...
            $(".datatable tbody").on("click", ".status-data", function() {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    $(".modal-update-status .modal-title").html("Edit Status Pengumuman " + resp.subyek);
