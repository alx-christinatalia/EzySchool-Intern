    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Import Kategori Pengumuman</h4>
            </div>
            <form class="form-horizontal form-import-kategori" action="pengumuman/ajax-pengumuman-kategori.html" role="form">
            ...
            <form id="FrmProsesExcel" method="post" action="<?php echo base_url("pengumuman/kategori/import.html"); ?>">
