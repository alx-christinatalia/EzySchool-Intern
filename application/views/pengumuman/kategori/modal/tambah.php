    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Tambah Kategori Pengumuman</h4>
            </div>
            <form method="POST" action="pengumuman/ajax-pengumuman-kategori.html" class="form-horizontal form-kategori-baru">
                <div class="modal-body">
                    <div>
                      <label>Nama Kategori</label>
                      <input required type="text" class="form-control" placeholder="Nama Kategori Pengumuman" name="form[nama]">
                      <br>
                    </div>
                </div>
