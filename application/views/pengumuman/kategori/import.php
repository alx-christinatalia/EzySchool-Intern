...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Import Kategori Pengumuman | EzySchool Sekolah</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="page-title">
                                    <h1><i class="fa fa-bullhorn"></i> Import Kategori Pengumuman</h1>
                                </div>
                            </div>
                    ...
                    <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active text-default">
                                <a href="<?php echo base_url("pengumuman/kategori.html");?>">Kategori Pengumuman</a>
                            </span>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span class="active text-default">
                                <a href="#" onclick="location.reload();">Import Kategori Pengumuman</a>
                            </span>
                        </li>
                    </ul>
                                ...
                                <div class="portlet custom light bordered">
                                    <div class="portlet-body">
                                        <div class="table-container">
                                            <form class="form-horizontal form-tambah-kategori" action="pengumuman/ajax-pengumuman-kategori.html" role="form">
        ...
        <?php $this->load->view("pengumuman/kategori/modal/import") ?>
        ...
        <script>
            pagename = "pengumuman/ajax-pengumuman-kategori-import.html";
            $(document).ready(function() {
                getdatadropdownkategori("",2);
            ...
            function tempeldata(id_update, FrmSave) {
                ...
                getdatabyid(id_update, function(resp) {
                    ...
                    setTimeout(function() {
                        $.each(resp.Data, function(index, item) {
                            index2 = index+1;
                            $("#mt-repeater-tbody .mt-repeater-item:nth-child("+index2+")").find(".dropdown-kategori").val(item.jns_kategori,2).trigger("change");
                        });
                    }, 1200);
                });
            }
