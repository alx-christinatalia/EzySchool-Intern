...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Tambah Pengumuman | <?php echo $this->config->item("app_title"); ?></title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="page-title">
                                    <h1><i class="fa fa-bullhorn"></i> Tambah Pengumuman</h1>
                                </div>
                                <ul class="page-breadcrumb breadcrumb col-xs-12" style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" >
                                    ...
                                    <li>
                                        <span class="active text-default">
                                            <a onclick="location.reload();"> Tambah Pengumuman</a>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <form method="POST" action="pengumuman/ajax-pengumuman.html" class="form-horizontal form-pengumuman-baru">
                        ...
                        <div class="hidden tambahpengumuman row">
                            <div class="col-md-8">
                                ...
                                <div class="content-box">
                                    <div class="portlet light bordered section2 textarea-isi">
                                        <div class="portlet-body">
                                            <textarea class="pesan form-control" name="form[pesan]" style="width: 100%;min-height: 300px;resize: vertical;" required></textarea>
                            ...
                            <div class="col-md-4">
                                            ...
                                            <div style="padding-left:15px; padding-right: 15px;">
                                                <div>
                                                    <div class='input-group date' style="margin-bottom: 10px;">
                                                        <input id='datetimepicker6' disabled type='text' class="form-control tanggal tgl_eksekusi_edit date-set" placeholder="Tanggal Post" value="<?php echo $date; ?>" name="form[tgl]"/>
                                ...
                                <div class="portlet light bordered section2 mrg-btm15">
                                    ...
                                    <div class="portlet-body">
                                        <select id="select-kategori" style="width:100%;" class="select2-mulitple dropdown-kategori" multiple></select>
                                ...
                                <div class="portlet light bordered section2 mrg-btm15">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="show-kelas collapse">
                                            <br>
                                            <label class="bold">Kelas</label>
                                            <input type="text" value="" class="object_tagsinput tagsinput_kelas">
                                            <br>
                                            <a href="#pilihkelas" role="button" data-toggle="modal" class="btn btn-primary">
                                                <i class="fa fa-plus"></i> Tambah Kelas
                                            </a>
                                            <input type="hidden" value="" class="tagsinput_kelas_hidden">
                                        </div>
                                        <div class="show-siswa collapse">
                                            <br>
                                            <label class="bold">Siswa</label>
                                            <input type="text" value="" class="object_tagsinput tagsinput_siswa">
                                            <br>
                                            <a href="#pilihsiswa" role="button" data-toggle="modal" class="btn btn-primary">
                                                <i class="fa fa-plus"></i> Tambah Siswa
                                            </a>
                                            <input type="hidden" value="" class="tagsinput_siswa_hidden">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                getdatadropdownpegawai(<?php echo $user->id; ?>);
            ...
            var FrmSaveWebsite = $(".form-pengumuman-baru").validate({
                submitHandler: function(form) {
                    $(".loading-tambahpengumuman").removeClass("hidden");
                    $(".tambahpengumuman").addClass("hidden");
                    InsertDataAjax(form, function(resp) {
                        setTimeout(function() {
                            window.location.href = "<?php echo base_url("pengumuman/edit.html?id=")?>" + resp.Output;
                        }, 750);
                    });
                },
            ...
            $(".status-publish").change(function() {
                if($(".status-publish").is(':checked')){
                    ...
                    $(".tgl_eksekusi_edit, .date-set").removeAttr('required');
