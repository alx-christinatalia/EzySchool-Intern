...
<!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Tambah Wali Kelas | <?php echo $this->config->item("app_title"); ?></title>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-8 col-xs-12">
                                <div class="page-title">
                                    <h1 class="title-edit"><i class="fa fa-database"></i> Tambah Wali Kelas</h1>
                                </div>
                            </div>
                    ...
                    <ul style="padding-bottom: 0px; margin-top: 5px; margin-bottom: 15px;" class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active text-default">
                                <a href="#" class="button-reload" onclick="location.reload();">Tambah Wali Kelas</a>
                            </span>
                        </li>
                    </ul>
                            ...
                            <div class="col-md-12">
                                <div class="portlet custom light bordered">
                                    <div class="portlet-body">
                                        <form class="form-horizontal form-datapegawai-baru" action="master-data/ajax-wali-kelas.html" role="form">
                                            ...
                                            <div class="form-group add-pegawai">
                                                ...
                                                <div class="col-md-5">
                                                    <input required type="password" class="form-control pass1" placeholder="Password" minlength="6" maxlength="8"/>
                                                    <input type="hidden" name="form[password1]" class="hidden-pass1">
                                                </div>
                                            </div>
                                            <div class="form-group add-pegawai">
                                                <label class="control-label col-md-3"> Ketik Ulang Password <span class="text-danger">*</span></label>
                                                <div class="col-md-5">
                                                    <input required type="password" class="form-control pass2" placeholder="Ketik Ulang Password" minlength="6" maxlength="8"/>
                                                    <input type="hidden" name="form[password2]" class="hidden-pass2">
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary ladda-button ladda-button-submit add-pegawai" data-style="slide-up">Simpan</button>
