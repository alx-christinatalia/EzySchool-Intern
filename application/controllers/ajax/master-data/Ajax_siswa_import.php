...
class Ajax_siswa_import extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model("master-data/siswa_import");
	}
    ...
    private function listdatahtml() {
        //$this->req["Limit"] = 5;
        $Request = $this->siswa_import->HtmlDatasiswa($this->req);
        return $Request;
    }
    private function getdatabyid() {
        $Request = $this->siswa_import->GetDatasiswaimport(["filter" => ["ExcelPath" => $this->req]]);
