...
class Ajax_kelas_import extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model("master-data/kelas_import");
	}
    ...
    private function listdatahtml() {
        //$this->req["Limit"] = 5;
        $Request = $this->kelas_import->HtmlMdkelas($this->req);
        return $Request;
    }

    private function getdatabyid() {
        $Request = $this->kelas_import->Getkelasimport(["filter" => ["ExcelPath" => $this->req]]);
