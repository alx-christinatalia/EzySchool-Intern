...
class Ajax_pengumuman_kategori_import extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model("pengumuman/pengumuman_kategori_import");
	}
    ...
    private function listdatahtml() {
        //$this->req["Limit"] = 5;
        $Request = $this->pengumuman_kategori_import->HtmlMdkategori($this->req);
        return $Request;
    }

    private function getdatabyid() {
        $Request = $this->pengumuman_kategori_import->Getkategoriimport(["filter" => ["ExcelPath" => $this->req]]);
