...
class Ajax_user_import extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model("administrator/user_import");
	}
    ...
    private function listdatahtml() {
        //$this->req["Limit"] = 5;
        $Request = $this->user_import->HtmlPegawai($this->req);
        return $Request;
    }
    private function getdatabyid() {
        $Request = $this->user_import->GetPegawaiimport(["filter" => ["ExcelPath" => $this->req]]);
