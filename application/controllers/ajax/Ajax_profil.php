...
class Ajax_profil extends CI_Controller {
    ...
    private function uploadfoto() {
        $Request = $this->profil->UploadImage($this->req);
        return $Request;
    }

    private function updatedata() {
        $id_update = $this->form["id_update"]; unset($this->form["id_update"]);
        $Request = $this->profil->UpdatePengguna($id_update, $this->form);
        return $Request;
    }
    ...
    private function updatepassword() {
        ...
        $Request = $this->profil->UpdatePasswordPengguna($id_update, $this->form);
        return $Request;
    } 
}
