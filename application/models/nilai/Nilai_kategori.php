<?php
	...
	class Nilai_kategori extends CI_Model {
		...
		public function GetKategoriNilai($param) {
		...
		public function HtmlKategoriNilai($param) {
			$rHtml ="";

			$query = $this->GetKategoriNilai($param);
		...
		public function UploadKategoriNilai($param) {
		...
		public function InsertKategoriNilai($args) {
			$args['user_key'] = $this->user->user_key;
        	$args["db"] = $this->db;
        	$args['jns_kat'] = 3;
        ...
        public function InsertKategoriNilaiRepeat($args) {
        	$args['user_key'] = $this->user->user_key;
        	$args["db"] = $this->db;
        	$args['jns_kat'] = 3;
        ...
        public function UpdateKategoriNilai($id_update, $param) {
