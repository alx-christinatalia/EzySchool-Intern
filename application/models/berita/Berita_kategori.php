<?php
	...
	class Berita_kategori extends CI_Model {
		...
		public function GetKategoriBerita($param) {
		...
		public function HtmlKategoriBerita($param) {
			$rHtml ="";

			$query = $this->GetKategoriBerita($param);
		...
		public function UploadKategoriBerita($param) {
		...
		public function InsertKategoriBerita($args) {
			$args['user_key'] = $this->user->user_key;
        	$args["db"] = $this->db;
        	$args['jns_kat'] = 1;
        ...
        public function InsertKategoriBeritaRepeat($args) {
        	$args['user_key'] = $this->user->user_key;
        	$args["db"] = $this->db;
        	$args['jns_kat'] = 1;
        ...
        public function UpdateKategoriBerita($id_update, $param) {
