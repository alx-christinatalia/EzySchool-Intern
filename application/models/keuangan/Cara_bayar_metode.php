<?php
	...
	class Cara_bayar_metode extends CI_Model {
		...
		public function GetMdpembayaranmetode($param) {
			...
			$this->api->set("master-data/pembayaran/metode", $args);
			return $this->api->exec();
		}

		public function HtmlMdpembayaranmetode($param) {
			$rHtml ="";

			$query = $this->GetMdpembayaranmetode($param);
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                	<li><a href="'.base_url("cara_bayar/step.html?id=".$item->id).'" role="button"><i class="fa fa fa-check-square-o"></i> Lihat Step</a></li>
