<?php
	...
	class Cara_bayar extends CI_Model {
		...
		public function GetMdpembayaran($param) {
			...
			$this->api->set("master-data/pembayaran/kategori", $args);
			return $this->api->exec();
		}

		public function HtmlMdpembayaran($param) {
			$rHtml ="";

			$query = $this->GetMdpembayaran($param);
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                	<li><a href="'.base_url("cara_bayar/metode.html?id=".$item->id).'" role="button"><i class="fa fa-search-plus"></i> Lihat Metode</a></li>
