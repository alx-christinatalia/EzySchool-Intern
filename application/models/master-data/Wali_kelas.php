<?php
	...
	class Wali_kelas extends CI_Model {
		...
		public function GetPegawai($param) {
			...
			$this->api->set("pegawai/list", $args);
				...
				if(!empty($query->Data)) {
					foreach ($query->Data as $item) {
						...
						$rHtml .= '<tr>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a role="button" href="'.base_url("wali_kelas/edit.html?id=".$item->id).'"><i class="fa fa-pencil"></i> Edit User</a></li>
                                        ...
                                        <td><a href="'.base_url("wali_kelas/edit.html?id=".$item->id).'">'.$item->nama.'</a></td>
                                        <td>'.$jk.'</td>
                                        <td>'.$item->username.'</td>
                                        <td>'.$item->email.'</td>
        ...
        public function UploadFotoPegawai($param) {
			$args['user_key'] = $this->user->user_key;
			$param['FolderName'] = "image-pegawai";
			$param['db'] = $this->db;
        ...
        public function InsertDataPegawaiRepeat($args) {
        	$args["user_key"] = $this->user->user_key;
        	$args["db"] = $this->db;
        ...
        public function UpdateDataPegawaiRepeat($args) {
        	$args["user_key"] = $this->user->user_key;
        	$args["db"] = $this->db;

		    $this->api->set("pegawai/edit", $args);
		    $query = $this->api->exec();
